...
const HomePage = () => {
  ...
  // Remove excessive balance refresh - balance updates automatically from context
  // The BalanceContext already handles balance updates when needed
  ...
  }, [game?.player_sum, game?.status, game?.player_cards?.length]);
